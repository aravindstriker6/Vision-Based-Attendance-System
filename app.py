...
from face_training import TrainingDataCollector
from face_embedding import GenerateFaceEmbedding
from face_predictor import FacePredictor
from face_mtcnn import TrainFaceRecogModel
...
class RegistrationModule:
    def __init__(self, logFileName):
        ...
        self.window = tk.Tk()
        self.window.title("Student Attendance Registration")
        ...
        emailId = tk.Label(self.window, text="Mobile No:", width=10, fg="white", bg="#363e75", height=2, font=('times', 15))
        ...
        mobileNo = tk.Label(self.window, text="Email Id :", width=10, fg="white", bg="#363e75", height=2,
                            font=('times', 15))
